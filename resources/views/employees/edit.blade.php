<x-app-layout>
<x-slot name="header"><h2 class="text-xl font-semibold">Edit Employee</h2></x-slot>
<div class="py-6 max-w-3xl mx-auto sm:px-6 lg:px-8">
    <x-flash/>
    <form method="POST" action="{{ route('employees.update',$employee) }}" class="bg-white p-4 rounded shadow">
        @csrf @method('PUT')
